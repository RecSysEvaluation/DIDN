...
class SequentialRules:
    ...
    def __init__(self, steps=10, weighting='div', pruning=20, last_n_days=None, idf_weight=False, last_in_session=False,
                 session_weighting='div', session_key='SessionId', item_key='ItemId', time_key='Time'):
    ...
    def predict_next(self, input_item_id, predict_for_item_ids, skip=False, mode_type='view'):
        '''
